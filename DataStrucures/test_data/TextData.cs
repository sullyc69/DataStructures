...
namespace DataStrucures.test_data
{
    public class TextData
    {
        ...
        {
            return @"But I must explain to you how all this mistaken idea of denouncing of a pleasure and praising pain
                    ...
                    loves or pursues or desires to obtain pain of itself, because it is pain, but occasionally circumstances
                    ...
                    is the same as saying through shrinking from toil and pain. These cases are perfectly simple and easy to distinguish. 
